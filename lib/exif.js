...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        const wr = { a: global.author ? global.author : 'SethB~', b: data.packname ? data.packname : global.packname ? global.packname : 'stikkerrr', c: data.author ? data.author : global.author ? global.author : 'SethB~', d: data.categories ? data.categories : [""], e: data.isAvatar ? data.isAvatar : 0 }
